<template>
  <div class="cms-page-wrapper">
    ...
    <div class="cms-page">
      ...
      <banner-form
        ref="bannerForm"
        url="/cms/pages/update-banner/insights"
        :data="bannerContents"
        v-if="pageContents.length > 0"
      />

      <insights-table fetch-url="/cms/pages/insights/records"></insights-table>
    </div>

    <seo-form
      ref="seoForm"
      url="/cms/pages/update-seo/insights"
      :data="seoContents"
      v-if="pageContents.length > 0"
    />
...
export default {
  ...
  data() {
    return {
      contentsUrl: "/cms/pages/insights-contents",
      responses: [],
      disabled: false,
    };
  },
    ...
    async saveAll() {
      ...
      await Promise.all([
        ...
        if (this.responses.every((res) => res == "success")) {
          return flash("Insights Page has been updated!");
        }
